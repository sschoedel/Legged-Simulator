...
class FrontLeftShoulderConfig
{
    public:
        ...
        ci::vec3            mtDir2        = ci::vec3(8,0,0);
        int             thisMountIndex    = 0;                  // The index of the mounting vector this link uses to attach to its parent
	    int             parentMountIndex  = 0;                  // The index of the mounting vector of the parent this link is attaching to
        float           mass              = 1;
};